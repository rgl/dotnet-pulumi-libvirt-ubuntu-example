...
```bash
wget https://get.pulumi.com/releases/sdk/pulumi-v3.78.1-linux-x64.tar.gz
sudo tar xf pulumi-v3.78.1-linux-x64.tar.gz -C /usr/local/bin --strip-components 1
rm pulumi-v3.78.1-linux-x64.tar.gz
```
